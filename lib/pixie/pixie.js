(function() {
  ...
  function EffectsFilter() {
    ...
    this.fragmentSrc = [
      ...
      '     gl_FragColor = vec4(',
      '       hueShift < 0.33333 ?',
      '         mix(gl_FragColor.rgb, gl_FragColor.brg, hueShift * 3.) :',
      '       hueShift < 0.66667 ?',
      '         mix(gl_FragColor.brg, gl_FragColor.gbr, hueShift * 3. - 1.) :',
      '         mix(gl_FragColor.gbr, gl_FragColor.rgb, hueShift * 3. - 2.), gl_FragColor.a);',
      '  }',
      '  gl_FragColor *= alpha;',
      '}',
    ];
  ...
  def(EffectsFilter.prototype, 'brightness', {
  ...
  ScratchObj.prototype.updatePixi = function() {
    ...
    this.pixiEffectsFilter.brightness = this.effects.brightness / 100;
    var hs = this.effects.color / 200 % 1;
    this.pixiEffectsFilter.hueShift = hs < 0 ? hs + 1 : hs;
    if (this.effects.pixelate) {
      // this.pixiPixelateFilter.size.x =
      // this.pixiPixelateFilter.size.y = Math.min(Math.abs(this.effects.pixelate / 10) + 1, costume.width, costume.height);
      // filters.push(this.pixiPixelateFilter);
    }
  ...
  Stage.prototype.updatePixelRatio = function() {
