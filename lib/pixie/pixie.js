(function() {
  ...
  Watcher.prototype.fromJSON = function(json) {
    ...
    this.moveTo(Number(json.x) || 0, Number(json.y) || 0);
    this.sliderMin = Number(json.sliderMin) || 0;
    this.sliderMax = json.sliderMin == null ? 100 : Number(json.sliderMin) || 0;
