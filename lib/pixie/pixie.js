(function() {
  ...
  Stage.prototype.updateWatcher = function(kind, arg, target) {
    var watcher = this.findWatcher(kind, arg, target);
  ...
  Editor.prototype.toggleWatcher = function(array, force) {
    ...
    if (watcher) {
      watcher.visible = force == null ? !watcher.visible : force;
  ...
  Editor.prototype.removeWatcher = function(array) {
    var watcher = array[0] === 'contentsOfList:' ? this.findListWatcher(array[1]) : this.findWatcher(array);
    if (watcher) this.stage.remove(watcher);
  };
  ...
  CostumesPanel.prototype.select = function(icon) {
    ...
    if (this.selectedIcon = icon) {
      ...
      if (this.sprite.isStage) {
        this.sprite.updateWatcher('sceneName', undefined, this.sprite);
        this.sprite.updateWatcher('backgroundIndex', undefined, this.sprite);
      } else {
        this.sprite.stage.updateWatcher('costumeIndex', undefined, this.sprite);
      }
      this.sprite.redraw();
    }
  };
  ...
  SpritePanel.prototype.emptySprite = function() {
    return new Sprite(this.editor.stage.uniqueSpriteName(T('Sprite1')));
  };
