(function() {
  ...
  Interpreter.prototype.addPrimitives = function(table) {
    ...
    table['bounceOffEdge'] = function() {
        ...
        if (sprite.isSprite) {
            ...
            if (sprite.x >= "240"| sprite.x <= "-240" | sprite.y >= "180" | sprite.y <= "-180") {
                heading=0-heading;
                sprite.direction=heading;
                console.log("bounce off edge new heading "+heading);
            }
        }
     }
    ...
    table['changeVolumeBy:'] = function(b) {};
    table['setVolumeTo:'] = function(b) {};
 ...
 function SoundsPanel() {
  ...
  SoundsPanel.prototype.newFromFile = function(file) {
   IO.readImageFile(file, function(err, image) {
                  if (err) return;
                  this.addSound(Sound.centered(stripExtension(file.name), image));
                  }, this);
  };
