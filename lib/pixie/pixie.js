(function() {
  ...
  function TopBar(editor) {
    ...
    this.el = cl('top-bar', [
      ...
      this.elTools = cl('top-tools', [
        this.duplicateButton = this.addTool('duplicate', T('Duplicate')),
        this.deleteButton = this.addTool('delete', T('Delete')),
        this.growButton = this.addTool('grow', T('Grow')),
        this.shrinkButton = this.addTool('shrink', T('Shrink')),
        this.helpButton = this.addTool('help', T('Block help'))
      ])
    ]);
  ...
  TopBar.prototype.addTool = function(name, title) {
