(function() {
  ...
  ListWatcher.prototype.addItem = function() {
    ...
    var j = i == null ? length : Math.min(length, i + 1);
  ...
  ListWatcher.prototype.keyDown = function(e) {
    if (e.keyCode === 9 && this.editor) {
      e.preventDefault();
      var length = this.list.contents.length;
      this.edit((this.editor.index + (e.shiftKey ? length - 1 : 1)) % length);
    }
  };
  ...
  ListCell.prototype.startEdit = function() {
    ...
    if (!this.elField) {
      ...
      this.elField.style.width = this.elContents.style.width;
