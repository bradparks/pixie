(function() {
  ...
  Watcher.deserialize = function(stage, json) {
    ...
    return target && new Watcher(target, json.cmd, json.param, json.color).fromJSON(json);
  };
  ...
  Watcher.prototype.fromJSON = function(json) {
    ...
    this.mode = json.mode === WatcherMode.large || json.mode === WatcherMode.slider ? json.mode : WatcherMode.mormal;
    // TODO
    return this;
  };
