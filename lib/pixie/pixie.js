    ...
    this.el = cl('sprite-panel', [
      ...
      this.elStageSection = cl('stage-section', [
        ...
        this.elNewBackdrop = cl('new-backdrop', [
          _('New backdrop:'),
          this.makeNewButton('new-small-backdrop-library', _('Choose backdrop from library'), this.newBackdropFromLibrary),
          this.makeNewButton('new-small-paint', _('Paint new backdrop'), this.newBackdropFromEditor),
          this.makeNewButton('new-small-import', _('Upload backdrop from file'), this.newBackdropFromFile, 'image/*'),
          this.makeNewButton('new-small-camera', _('New backdrop from camera'), this.newBackdropFromCamera)
        ])
      ]),
      ...
      this.elSpriteInfo = cl('sprite-info', [
        ...
        this.elSpriteInfoMotion = cl('sprite-info-motion', [
          el('strong', [_('x:')]), cl('sprite-info-value', [0]),
          el('strong', [_('y:')]), cl('sprite-info-value', [0]),
          el('strong', {className: 'sprite-info-direction'}, [_('direction:')]), cl('sprite-info-value', ['90°'])
        ])
      ])
    ]);
